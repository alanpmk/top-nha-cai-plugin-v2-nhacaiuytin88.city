...
function OurComponent(props) {
  ...
  const Sidebar = ({
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      className: `bg-white rounded-none drop-shadow-lg p-2 text-black shadow-xl border border-slate-100`
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    }, "Ch\u01A1i Ngay")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
      href: item.link_review ? item.link_review : '/',
      className: `w-full bg-orange-400 hover:bg-orange-500 text-sm font-light text-center px-2 py-2 rounded-none flex items-center justify-center space-x-1 whitespace-nowrap
                 `,
      target: "_blank",
      rel: "nofollow sponsored noopener"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", {
  ...
  const MainContent = ({
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, listbets && listbets.map((item, index) => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      className: `min-w-40 bg-orange-400 hover:bg-orange-500 text-sm font-light text-center px-2 py-2 rounded-none flex items-center justify-center space-x-1 whitespace-nowrap
                 `,
      target: "_blank",
      rel: "nofollow sponsored noopener"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", {
      ...
      className: "text-white"
    }, "Xem Review")))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
